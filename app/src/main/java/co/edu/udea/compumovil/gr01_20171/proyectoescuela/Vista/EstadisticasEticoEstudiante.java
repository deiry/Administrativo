...
public class EstadisticasEticoEstudiante extends Activity {
    ...
    private  void llenarGridViewSubcategorias(){
        ...
        gridEstudiante.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(getApplicationContext(),"El estudiante ha realizado "+nombreCategorias[position],Toast.LENGTH_SHORT).show();
            }
        });
    }
